function datagrammer = st_read_datagrammer(cfg, filename)
% ST_READ_DATAGRAMMER read a datagrammer file
%
% Use as
%   datagrammer = st_read_datagrammer(cfg, filename)
%
...
%
% See also ST_READ_MONTAGE, ST_PREPROCESSING
...
datagrammerTable = readtable(filename,parampairs{:});

datagrammer = [];
datagrammer.channel  = table2cell(datagrammerTable(1:end,1));
datagrammer.grammer  = table2cell(datagrammerTable(1:end,2));
