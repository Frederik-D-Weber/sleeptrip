...
for iScoringCycle = 1:numel(scoring_cycles)
    ...
    interrupt_duration_min_by_IntType_and_ScoringPart = cell(nInterruptTypes,nscoringparts);
    timewindow_min_by_IntType_and_ScoringPart = nan(nInterruptTypes,nscoringparts);
    Interruptions_in_bouts_by_IntType_and_ScoringPart = nan(nInterruptTypes,nscoringparts);
    mean_Duration_min_by_IntType_and_ScoringPart = nan(nInterruptTypes,nscoringparts);
    overall_Duration_min_by_IntType_and_ScoringPart = nan(nInterruptTypes,nscoringparts);
    ...
    for iInterruptType = 1:nInterruptTypes
        ...
        for iScoringPart = 1:numel(scoringparts_start)
            ...
            for iCycle = 1:nCycles
                ...
                if isnan(rangestart(iCycle)) || isnan(rangestop(iCycle)) || isempty(scoringpart_range)
                    ...
                    if isfield(scoring, 'arousals')
                        ...
                        %nArousals = size(scorings_cut2_appended.arousals,1);
                    end
                    ...
                    if isempty(consecBegins)
                        consecDur_wholescoring_seconds = 0;
                    else
                        ...
                        Interruptions_in_bouts = numel(interupptions_durations_min);
            ...
            interrupt_duration_min_by_IntType_and_ScoringPart{iInterruptType,iScoringPart} = cat(1,interrupt_duration_min_byScoringPart_and_Cycle{iScoringPart,:});
            
            overall_Duration_min_by_IntType_and_ScoringPart(iInterruptType,iScoringPart) = nansum(interrupt_duration_min_by_IntType_and_ScoringPart{iInterruptType,iScoringPart});
            mean_Duration_min_by_IntType_and_ScoringPart(iInterruptType,iScoringPart) = nanmean(interrupt_duration_min_by_IntType_and_ScoringPart{iInterruptType,iScoringPart});
            Interruptions_in_bouts_by_IntType_and_ScoringPart(iInterruptType,iScoringPart) = nansum(Interruptions_in_bouts_byScoringPart_and_Cycle(iScoringPart,:));
            timewindow_min_by_IntType_and_ScoringPart(iInterruptType,iScoringPart) = nansum(timewindow_seconds_by_ScoringPart_and_Cycle(iScoringPart,:))/60;
    ...
    table_tmp = table(...
        ...
        overall_Duration_min_by_IntType_and_ScoringPart(1,1), ...
        mean_Duration_min_by_IntType_and_ScoringPart(1,1), ...
        Interruptions_in_bouts_by_IntType_and_ScoringPart(1,1), ...
        Interruptions_in_bouts_by_IntType_and_ScoringPart(1,1)/timewindow_min_by_IntType_and_ScoringPart(1,1), ...
        overall_Duration_min_by_IntType_and_ScoringPart(1,2), ...
        mean_Duration_min_by_IntType_and_ScoringPart(1,2), ...
        Interruptions_in_bouts_by_IntType_and_ScoringPart(1,2), ...
        Interruptions_in_bouts_by_IntType_and_ScoringPart(1,2)/timewindow_min_by_IntType_and_ScoringPart(1,2), ...
        overall_Duration_min_by_IntType_and_ScoringPart(1,3), ...
        mean_Duration_min_by_IntType_and_ScoringPart(1,3), ...
        Interruptions_in_bouts_by_IntType_and_ScoringPart(1,3), ...
        Interruptions_in_bouts_by_IntType_and_ScoringPart(1,3)/timewindow_min_by_IntType_and_ScoringPart(1,3), ...
        overall_Duration_min_by_IntType_and_ScoringPart(2,1), ...
        mean_Duration_min_by_IntType_and_ScoringPart(2,1), ...
        Interruptions_in_bouts_by_IntType_and_ScoringPart(2,1), ...
        Interruptions_in_bouts_by_IntType_and_ScoringPart(2,1)/timewindow_min_by_IntType_and_ScoringPart(2,1), ...
        overall_Duration_min_by_IntType_and_ScoringPart(2,3), ...
        mean_Duration_min_by_IntType_and_ScoringPart(2,3), ...
        Interruptions_in_bouts_by_IntType_and_ScoringPart(2,3), ...
        Interruptions_in_bouts_by_IntType_and_ScoringPart(2,3)/timewindow_min_by_IntType_and_ScoringPart(2,3), ...
        overall_Duration_min_by_IntType_and_ScoringPart(3,2), ...
        mean_Duration_min_by_IntType_and_ScoringPart(3,2), ...
        Interruptions_in_bouts_by_IntType_and_ScoringPart(3,2), ...
        Interruptions_in_bouts_by_IntType_and_ScoringPart(3,2)/timewindow_min_by_IntType_and_ScoringPart(3,2), ...
        timewindow_min_by_IntType_and_ScoringPart(1,1), ...
        timewindow_min_by_IntType_and_ScoringPart(1,2), ...
        timewindow_min_by_IntType_and_ScoringPart(1,3), ...
        ...
        'interrupts_W_MT_overall_durations_min_in_all_NR_episodes', ...
        'interrupts_W_MT_mean_durations_min_in_NR_episodes', ...
        'interrupts_W_MT_number_in_all_NR_episodes', ...
        'interrupts_W_MT_density_per_min_in_all_NR_episodes', ...
        'interrupts_W_MT_overall_durations_min_in_all_R_episodes', ...
        'interrupts_W_MT_mean_durations_min_in_all_R_episodes', ...
        'interrupts_W_MT_number_in_all_R_episodes', ...
        'interrupts_W_MT_density_per_min_in_all_R_episodes', ...
        'interrupts_W_MT_overall_durations_min_in_all_ascNR_episodes', ...
        'interrupts_W_MT_mean_durations_min_in_all_ascNR_episodes', ...
        'interrupts_W_MT_number_in_all_ascNR_episodes', ...
        'interrupts_W_MT_density_per_min_in_all_ascNR_episodes', ...
        'interrupts_W_MT_N1_overall_durations_min_in_all_NR_episodes', ...
        'interrupts_W_MT_N1_mean_durations_min_in_NR_episodes', ...
        'interrupts_W_MT_N1_number_in_all_NR_episodes', ...
        'interrupts_W_MT_N1_density_per_min_in_all_NR_episodes', ....
        'interrupts_W_MT_N1_overall_durations_min_in_all_ascNR_episodes', ...
        'interrupts_W_MT_N1_mean_durations_min_in_all_ascNR_episodes', ...
        'interrupts_W_MT_N1_number_in_all_ascNR_episodes', ...
        'interrupts_W_MT_N1_density_per_min_in_all_ascNR_episodes', ...
        'interrupts_W_MT_NR_overall_durations_min_in_all_R_episodes', ...
        'interrupts_W_MT_NR_mean_durations_min_in_all_R_episodes', ...
        'interrupts_W_MT_NR_number_in_all_R_episodes', ...
        'interrupts_W_MT_NR_density_per_min_in_all_R_episodes', .....
        'cycle_overall_duration_min_NR_episodes', ...
        'cycle_overall_duration_min_R_episodes', ...
        'cycle_overall_duration_min_ascNR_episodes', ...
        'cycle_label',...
        'cycle_complete'}...
        );
