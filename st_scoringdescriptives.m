...
% if scoring.lightsoff and scoring.lightson fields are present are set (in seconds since recording onset)
% they will be used for sleep onset (latency)
% the columns N1_delay_min, N2_delay_min, SWS_delay_min, S4_delay_min,
% R_onset_min are considered time after sleep onset, i.e. if sleep onset is
...
for iScoringCycle = 1:numel(scoring_cycles)
    ...
    if ~isnan(onsetnumber)
        ...
        totalSleepTime = (length(onsetnumber:lastsleepstagenumber))*scoring.epochlength;
    else
    ...
    table_tmp = table(...
        ...
        100*(NRtime+N1Time)/totalSleepTime, ...
        ...
        100*(NRtime_without_excluded+N1Time_without_excluded)/totalSleepTime, ...
        ...
        'VariableNames',{'scoringfile','standard','epoch_length_seconds','Total_sleep_time_min','Sleep_onset_min','N1_onset_min','N2_delay_min','SWS_delay_min','S4_delay_min','R_delay_min'...
        ...
        ,'N1_percent','N2_percent','N3_percent','S4_percent','R_percent','Wake_after_sleep_onset_percent','Movement_Time_percent','Artifact_percent','Unknown_percent','SWS_percent','NR_with_N1_percent','NR_without_N1_percent'...
        ...
        'NR_number_of_bouts',...
        'Sleep_number_of_bouts',...
        'nonSleep_number_of_bouts',...
        'cycle_label',...
        'cycle_complete',...
