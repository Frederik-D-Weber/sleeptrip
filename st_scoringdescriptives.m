...
%                        'NR' or 'NR' or 'XR', see ST_SLEEPONSET for details (default = 'N1_XR')
%
...
fprintf('st_scoringdescriptives function initialized\n');
...
WakeTime = length(find(strcmp(hypnStagesTST(:,1),'Wake')))*scoring.epochlength;
...
WakeTimePreOnset = length(find(strcmp(hypnStagesPreSleepOnset(:,1),'Wake')))*scoring.epochlength;
...
WakeTime_without_excluded = length(find(strcmp(hypnStagesTST(:,1),'Wake') & (hypnTST_excluded == 0)' ))*scoring.epochlength;
...
res.table = table(...
    ...
    ,'N1_min','N2_min','N3_min','S4_min','R_min','Wake_after_sleep_onset_min','Movement_Time_min','SWS_min','NR_without_N1_min'...
    ,'N1_percent','N2_percent','N3_percent','S4_percent','R_percent','Wake_after_sleep_onset_percent','Movement_Time_percent','SWS_percent','NR_without_N1_percent'...
    ,'N1_without_excluded_min','N2_without_excluded_min','N3_without_excluded_min','S4_without_excluded_min','R_without_excluded_min','Wake_after_sleep_onset_without_excluded_min','Movement_Time_without_excluded_min','SWS_without_excluded_min','NR_without_N1_without_excluded_min'...
    ,'N1_without_excluded_percent','N2_without_excluded_percent','N3_without_excluded_percent','S4_without_excluded_percent','R_without_excluded_percent','Wake_after_sleep_onset_without_excluded_percent','Movement_Time_without_excluded_percent','SWS_without_excluded_percent','NR_without_N1_without_excluded_percent'...
    ,'N1_before_sleep_onset_min','N2_before_sleep_onset_min','N3_before_sleep_onset_min','S4_before_sleep_onset_min','R_before_sleep_onset_min','Wake_before_sleep_onset_min','Movement_before_sleep_onset_Time_min','SWS_before_sleep_onset_min','NR_before_sleep_onset_without_N1_min'...
    ,'longest_WASO_period_min','longest_WASO_period_after_latency_after_so_min'}...
    );


fprintf('st_scoringdescriptives function finished\n');
