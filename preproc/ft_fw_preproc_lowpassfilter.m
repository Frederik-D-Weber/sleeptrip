function [filt] = ft_preproc_lowpassfilter(dat,Fs,Flp,N,type,dir,instabilityfix,cfg)
...
%           if rem(N,2)==1,   N=N+1;    end
%       end
      transitionsWidthHz = cfg.PassToStopTransitionWidth_lp;

      Flp_nq = Flp/Fn;
      Flp_trans_nq =(Flp+transitionsWidthHz)/Fn;
      f = [0 Flp_nq Flp_trans_nq  1];
      z = [1 1 0 0];
      A = 1;
      B = firls(N,f,z); % requires Matlab signal processing toolbox
  case 'brickwall'
