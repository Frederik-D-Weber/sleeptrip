...
if strcmp(cfg.lpfilter, 'yes'),     dat = ft_fw_preproc_lowpassfilter(dat, fsample, cfg.lpfreq, cfg.lpfiltord, cfg.lpfilttype, cfg.lpfiltdir, cfg.lpinstabilityfix,cfg); end
if strcmp(cfg.hpfilter, 'yes'),     dat = ft_fw_preproc_highpassfilter(dat, fsample, cfg.hpfreq, cfg.hpfiltord, cfg.hpfilttype, cfg.hpfiltdir, cfg.hpinstabilityfix,cfg); end
if strcmp(cfg.bpfilter, 'yes'),     dat = ft_fw_preproc_bandpassfilter(dat, fsample, cfg.bpfreq, cfg.bpfiltord, cfg.bpfilttype, cfg.bpfiltdir, cfg.bpinstabilityfix,cfg); end
