function [prcInBurst funName remEpochs]= allNightREM1PrcInMidBurstsFromExactVct(hip, epochLength, exactREMsVct, sampling)


funName = 'allNightR1%IMidB';
...
%sumOutBurst = sumREM - sumInBurst;

if sumREM > 0

    prcInBurst = 100* (sumInBurst / sumREM);
