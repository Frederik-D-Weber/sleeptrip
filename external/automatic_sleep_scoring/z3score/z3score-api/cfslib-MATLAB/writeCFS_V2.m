...
% THE SOFTWARE.
function writeCFS_V2(fileName, C3, C4, EOGL, EOGR, EMG, fsamp_EEG, fsamp_EOG, fsamp_EMG, varargin)
...
stream = streamCFS_V2(C3, C4, EOGL, EOGR, EMG, fsamp_EEG, fsamp_EOG, fsamp_EMG, compress, hash);
