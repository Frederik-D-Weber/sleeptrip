...
if istrue(cfg.UseSecondColumnAndOnlyOffsetsForTimeWindowTarget) && istrue(cfg.MismatchIdenticalEvents)
    ft_error(['IMPORTANT: cfg.UseSecondColumnAndOnlyOffsetsForTimeWindowTarget = ''ýes'' and cfg.MismatchIdenticalEvents = ''ýes'' is not supported.'  ])
end

if istrue(cfg.UseSecondColumnAndOnlyOffsetsForTimeWindowTest) && istrue(cfg.MismatchIdenticalEvents)
    ft_error(['IMPORTANT: cfg.UseSecondColumnAndOnlyOffsetsForTimeWindowTest = ''ýes'' and cfg.MismatchIdenticalEvents = ''ýes'' is not supported.'  ])
end
