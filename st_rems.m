...
tempvarnames = {'channel',...
            'count',...
            'density_per_REM_epoch','density_per_REM_without_MA_epoch',...
            'density_per_minute_REM','density_per_minute_REM_without_MA_epoch',...
...
%         'VariableNames',tempvarnames);
    ...
    res_rems_channel.table = table(...
        {[channel_label_EOG_left '+' channel_label_EOG_right]},...
        nDetected,...
        nDetected/nEpochs_REM,nDetected/nEpochs_REM_withoutMA,...
        nDetected/(nEpochs_REM*scoring.epochlength/60) ,nDetected/(nEpochs_REM_withoutMA*scoring.epochlength/60),...
