function [dat] = read_edf(filename, hdr, begsample, endsample, chanindx, rereadhdr)
...
%   ['Label: ' EDF.Label ' | ' ...
%     'Transducer: ' EDF.Transducer ' | ' ...
%     'PhysDim: ' EDF.PhysDim ' | ' ...
%     'PhysMin: ' num2str(EDF.PhysMin) ' | ' ...
%     'PhysMax: ' num2str(EDF.PhysMax) ' | ' ...
%     'DigMin: ' num2str(EDF.DigMin) ' | ' ...
%     'DigMax: ' num2str(EDF.DigMax) ' | ' ...
%     'PreFilt: ' EDF.PreFilt ' | ' ...
%     'SPR: ' num2str(EDF.SPR) ' | ' ...
%     'Cal: ' num2str(EDF.Cal) ' | ' ...
%     'Off: ' num2str(EDF.Off) ' | ' ...
%     'SampleRate: ' num2str(EDF.SampleRate) ' | ' ...
%     'ChanTyp: ' EDF.ChanTyp ' | ' ...
%     '']
