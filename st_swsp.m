...
res_swsp_channel_stat.table = grpstats(res_swsp_event.table, idcols_temp,...
    ...
    'DataVars',{...
    'sp_duration_seconds', 'sp_amplitude_peak2trough_potential', 'sp_frequency_by_mean_pk_trgh_cnt_per_dur',...
    'sw_duration_seconds', 'sw_amplitude_peak2trough_potential', 'sw_slope_to_trough_min_potential_per_second', 'sw_slope_zeroxing_to_trough_potential_per_second', 'sw_slope_trough_to_up_max_potential_per_second', 'sw_slope_trough_to_zeroxing_potential_per_second','sw_frequency_by_duration','sw_frequency_by_trough_to_peak_latency',...
...
res_nonswsp_channel_stat.table = grpstats(res_nonswsp_event.table,idcols_temp,...
    {'mean','median','min','max','std'},...
    'DataVars',{...
    'sp_duration_seconds', 'sp_amplitude_peak2trough_potential', 'sp_frequency_by_mean_pk_trgh_cnt_per_dur','sp_lengths_ROI_seconds',...
    });
